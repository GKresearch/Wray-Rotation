...
#read in data
SE <- fread(file = "C:/Users/Ictinike/Documents/WrayLab/K562-DHS-v6.noChIP.csv")

#read in data dictionary
DD <- fread(file = "C:/Users/Ictinike/Documents/WrayLab/README_K562-DHS-v6-noChIP.txt")
...
PC <- fread(file = "C:/Users/Ictinike/Documents/WrayLab/K562.selection.csv")
...
randomForest(x = rf_pred_df, y = rf_resp_vector,  ntree = 1000)
str(rf_pred_df)
tic()
